...
let value = { HashKey = "1" ; Value = 40 ; Value2 = None ; Values = [|{ A = "foo" ; B = System.Reflection.BindingFlags.Instance }|] ; Map = Map.ofList [("A1",1)] ; Set = Set.empty }
...
table.UpdateItemAsync(key, <@ fun r -> { r with Set = r.Set - set [3L] } @>) |> Async.RunSynchronously
